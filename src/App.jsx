...
const KEYWORDS_MAPPING = {
  ...
  'อากาศ': ['อากาศ', 'ฝนตก', 'ร้อน', 'หนาว', 'ร้อนมาก', 'โคตรร้อน', 'แดดแรง'],
  ...
  'เรื่องเงิน': ['จน', 'ไม่มีเงิน', 'ช็อต', 'เงินหมด', 'เงินเดือน', 'ไม่มีตัง', 'ตังหมด', 'ค่าใช้จ่าย', 'หนี้', 'ขอตัง', 'เปย์'],
